...
<div class="container">
  <h2 style="padding: 15px">Update Voucher Card </h2>
    
  <form  class="form-horizontal" action="updatevouchercardbyid" method="post">
   
      <div class="form-group">
      <label class="control-label col-sm-2" >CardGroupSetId:</label>
         <div class="col-sm-10">
      <input type="text" class="form-control" placeholder="cardGroupSetId" name = "cardGroupSetId" >
        </div>
    </div>
    ...
    <div class="form-group">
      ...
      <label class="control-label col-sm-2" >ModuleCode:</label>
           <div class="col-sm-10">
      <input type="text" class="form-control" placeholder="ModuleCode" name = "moduleCode"  >
          </div>
    </div>
      <div class="form-group">
      ...
      <div class="form-group">
      <label class="control-label col-sm-2" >ModifiedBy:</label>
     <div class="col-sm-10">
      <input type="text" class="form-control" placeholder="ModifiedBy" name = "modifiedBy"  >
    </div>
      </div>
      <div class="form-group">
      <label class="control-label col-sm-2" >Language1Message:</label>
           <div class="col-sm-10">
      <input type="text" class="form-control" placeholder="Language1Message"  name = "language1Message">
          </div>
    </div>
      <div class="form-group">
      <label class="control-label col-sm-2" >Language2Message:</label>
           <div class="col-sm-10">
      <input type="text" class="form-control" placeholder="Language2Message"  name = "language2Mmessage" >
          </div>
    </div>
      <div class="form-group">
...
<center>    <input type="submit" onclick="myFunction()" class="btn btn-default" value="Update"></center>
  </form>
      </div>  
      </div>
  </div>
