...
<div class="container">
    <h2 style="padding: 15px">Delete VoucherCard </h2>
  <form  class="form-horizontal" action="deleteVoucherGroup" method="post">
      <!--<div class="form-group">
      <label class="control-label col-sm-2" >ServiceType:</label>
           <div class="col-sm-10">
      <input type="text" class="form-control" placeholder="cardGroupSetName" name = "serviceType" >
          </div>
      </div>-->
    ...
    <div class="form-group">
      <label class="control-label col-sm-2" >NetworkCode:</label>
           <div class="col-sm-10">
      <input type="text" class="form-control" placeholder="ModuleCode" name = "networkCode" value="NG">
          </div>
    </div>
      ...
      <label class="control-label col-sm-2" >ModuleCOde:</label>
           <div class="col-sm-10">
      <input type="text" class="form-control" placeholder="ModuleCode" name = "moduleCode" value="P2P">
          </div>
    </div>
      ...
      <div class="form-group">
      <label class="control-label col-sm-2" >LastVersion:</label>
           <div class="col-sm-10">
