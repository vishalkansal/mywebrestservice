...
<div class="container">
 <h2 style="padding: 15px">Set Default Voucher Card </h2>
  <form  class="form-horizontal" action="SetCardGroup" method="post">
    ...
    <div class="form-group">
      ...
      <div class="form-group">
      <label class="control-label col-sm-2" >CreatedBy:</label>
           <div class="col-sm-10">
      <input type="text" class="form-control" placeholder="CreatedBy" name = "createdBy" >
          </div>
    </div>
      <div class="form-group">
      <label class="control-label col-sm-2" >Version:</label>
           <div class="col-sm-10">
      <input type="text" class="form-control" placeholder="Version" name = "lastVersion" >
          </div>
    </div>
      <div class="form-group">
      ...
      <label class="control-label col-sm-2" >Default:</label>
           <div class="col-sm-10">
      <input type="text" class="form-control" placeholder="Default" name = "isDefault" >
          </div>
      </div>  
       <div class="form-group">
...
<center>  <input type="submit" onclick="myFunction()" class="btn btn-default" value="SET CARD"></center>  
